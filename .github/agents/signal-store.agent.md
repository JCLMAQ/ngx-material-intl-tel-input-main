...
model: Auto (copilot)
target: vscode
tools: ['runCommands', 'runTasks', 'edit', 'search', 'new', 'angular-cli/ai_tutor', 'angular-cli/find_examples', 'angular-cli/get_best_practices', 'angular-cli/list_projects', 'angular-cli/search_documentation', 'usages', 'problems', 'changes', 'todos', 'runSubagent']
---
...
- **RxJS for Async**: Avoid `rxMethod` for Observable-based operations
